            ...
            <form method="POST" id="developerForm" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        ...
                        <button type="button" id="closeModalBtn" class="btn btn-sm" aria-label="Close" data-bs-dismiss="modal">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.edit-dev-btn').forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            document.getElementById('addUserSelect').value = dev.user_id || (dev.user ? dev.user.id : '');
